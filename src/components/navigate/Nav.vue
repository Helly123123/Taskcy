...
.navigate {
  ...
  border-radius: 30px; /* Скругленные края как на макете */
  padding: 10px 20px;
}
...
/* Стили центральной кнопки */
.center-button {
  position: relative;
  flex: 0 0 60px; /* Фиксированная ширина для центра */
}

.fab {
  width: 46px;
  height: 46px;
  background-color: #7367f0; /* Фиолетовый цвет с макета */
  border: none;
  border-radius: 50%;
  color: white;
  font-size: 30px;
...
.plus-icon {
  line-height: 0;
  margin-top: -2px; /* Визуальное выравнивание плюса */
}
</style>
